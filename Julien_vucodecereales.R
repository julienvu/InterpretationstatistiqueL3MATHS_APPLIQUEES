...
#          normale de paramÃ¨tres (tau, sigma2)
# HypothÃ¨ses : on souhaite tester H0 : "tau = 0.9" contre H1 : "tau > 0.9"
# Variable de test : cbarre suit une N(tau, sigma2/n)
#                    d'oÃ¹ : (cbarre - tau)/(sigma/sqrt(n)) suit une N(0, 1)
...
# alpha = 0.05.
# Donc la décision est diffÃ©rente car on décide de rejeter H0. Auquel cas le producteur devra
# étiquetter ses céréales.

# Le risque de prendre cette dÃ©cision est le risque de première espèce qui est contrôlée et qui
